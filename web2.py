...
#----Input authorization-----
auth = 'authorization:Bearer 14263|l6TAa031aZBnkIfdnSYJhScXMMWEvyLbSq3qrse3'
...
while True:
  ...
  while message != "Task Completed":
    ...
    headers2 = {"Host": "info.tmswp.com", "accept": "application/json, text/plain, */*", "authorization": "Beasrer 269232|FYf0fiOhFskJzfTaCreVp14cIfKtrGm82zl1iZWR", "accept-encoding": "gzip", "user-agent": "okhttp/3.12.12"}
